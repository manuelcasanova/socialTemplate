  ...
  .post(
    ...
    .get(
      ...
      postsController.getPostReactionsData
        ...
        // Route to get posts comments reactions
        router.route('/comments/reactions/data')
        .get(
          async (req, res, next) => {
            try {
              // console.log("hit comments/reactions/data route")
              const rolesList = await fetchRoles();
          ...
          postsController.getPostCommentsReactionsData
        );
...
.post(
  ...
  postsController.sendReaction
    ...
    // Route to react to a post' comment
    router.route('/comments/reactions/send')
    ...
    .post(
      ...
      postsController.sendCommentReaction
    );
