...
const getAdminSettings = async (req, res) => {
  try {
    ...
    if (result.rows.length === 0) {
      return res.status(404).json({ error: 'No admin settings found' });
    }
...
const toggleAllowUserPost = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_user_post = $1 WHERE id = 1 RETURNING *;`,
      [allow_user_post]
    );
...
const toggleAllowAdminPost = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_admin_post = $1 WHERE id = 1 RETURNING *;`,
      [allow_admin_post]
    );
...
const toggleAllowPostInteractions = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_post_interactions = $1 WHERE id = 1 RETURNING *;`,
      [allow_post_interactions]
    );
...
const toggleAllowComments = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_comments = $1 WHERE id = 1 RETURNING *;`,
      [allow_comments]
    );
...
const toggleAllowPostReactions = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_post_reactions = $1 WHERE id = 1 RETURNING *;`,
      [allow_post_reactions]
    );
...
const toggleAllowCommentReactions = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_comment_reactions = $1 WHERE id = 1 RETURNING *;`,
      [allow_comment_reactions]
    );
...
const toggleAllowDeletePosts = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_delete_posts = $1 WHERE id = 1 RETURNING *;`,
      [allow_delete_posts]
    );
...
const toggleAllowFlagPosts = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_flag_posts = $1 WHERE id = 1 RETURNING *;`,
      [allow_flag_posts]
    );
...
const toggleAllowDeleteComments = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_delete_comments = $1 WHERE id = 1 RETURNING *;`,
      [allow_delete_comments]
    );
...
const toggleAllowFlagComments = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_flag_comments = $1 WHERE id = 1 RETURNING *;`,
      [allow_flag_comments]
    );
...
const toggleAllowSendMessages = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_send_messages = $1 WHERE id = 1 RETURNING *;`,
      [allow_send_messages]
    );
...
const toggleAllowDeleteMessages = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_delete_messages = $1 WHERE id = 1 RETURNING *;`,
      [allow_delete_messages]
    );
...
const toggleAllowFollow = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_follow = $1 WHERE id = 1 RETURNING *;`,
      [allow_follow]
    );
...
const toggleAllowMute = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_mute = $1 WHERE id = 1 RETURNING *;`,
      [allow_mute]
    );
...
const toggleAllowManageRoles = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_manage_roles = $1 WHERE id = 1 RETURNING *;`,
      [allow_manage_roles]
    );
...
const toggleAllowDeleteUsers = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_delete_users = $1 WHERE id = 1 RETURNING *;`,
      [allow_delete_users]
    );
...
const toggleAllowEditUsername = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_edit_username = $1 WHERE id = 1 RETURNING *;`,
      [allow_edit_username]
    );
...
const toggleAllowEditEmail= async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_edit_email = $1 WHERE id = 1 RETURNING *;`,
      [allow_edit_email]
    );
...
const toggleAllowEditPassword = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_edit_password = $1 WHERE id = 1 RETURNING *;`,
      [allow_edit_password]
    );
...
const toggleAllowDeleteMyUser = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_delete_my_user = $1 WHERE id = 1 RETURNING *;`,
      [allow_delete_my_user]
    );
...
const toggleAllowModifyProfilePicture = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `UPDATE admin_settings SET allow_modify_profile_picture = $1 WHERE id = 1 RETURNING *;`,
      [allow_modify_profile_picture]
    );
